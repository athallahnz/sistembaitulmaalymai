...
class AkunKeuanganSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('akun_keuangans')->insert([
            ...
            ['id' => 1011, 'kode_akun' => '101-1', 'nama_akun' => 'Kas Bendahara', 'tipe_akun' => 'Asset', 'parent_id' => 101, 'saldo_normal' => 'Debit'],
            ['id' => 1012, 'kode_akun' => '101-2', 'nama_akun' => 'Kas Kemasjidan', 'tipe_akun' => 'Asset', 'parent_id' => 101, 'saldo_normal' => 'Debit'],
            ['id' => 1013, 'kode_akun' => '101-3', 'nama_akun' => 'Kas Pendidikan', 'tipe_akun' => 'Asset', 'parent_id' => 101, 'saldo_normal' => 'Debit'],
            ['id' => 1014, 'kode_akun' => '101-4', 'nama_akun' => 'Kas Sosial', 'tipe_akun' => 'Asset', 'parent_id' => 101, 'saldo_normal' => 'Debit'],
            ['id' => 1015, 'kode_akun' => '101-5', 'nama_akun' => 'Kas Usaha', 'tipe_akun' => 'Asset', 'parent_id' => 101, 'saldo_normal' => 'Debit'],
            ['id' => 102, 'kode_akun' => '102', 'nama_akun' => 'Bank', 'tipe_akun' => 'Asset', 'parent_id' => null, 'saldo_normal' => 'Debit'],
            ['id' => 1021, 'kode_akun' => '102-1', 'nama_akun' => 'Bank Bendahara', 'tipe_akun' => 'Asset', 'parent_id' => 102, 'saldo_normal' => 'Debit'],
            ['id' => 1022, 'kode_akun' => '102-2', 'nama_akun' => 'Bank Kemasjidan', 'tipe_akun' => 'Asset', 'parent_id' => 102, 'saldo_normal' => 'Debit'],
            ['id' => 1023, 'kode_akun' => '102-3', 'nama_akun' => 'Bank Pendidikan', 'tipe_akun' => 'Asset', 'parent_id' => 102, 'saldo_normal' => 'Debit'],
            ['id' => 1024, 'kode_akun' => '102-4', 'nama_akun' => 'Bank Sosial', 'tipe_akun' => 'Asset', 'parent_id' => 102, 'saldo_normal' => 'Debit'],
            ['id' => 1025, 'kode_akun' => '102-5', 'nama_akun' => 'Bank Usaha', 'tipe_akun' => 'Asset', 'parent_id' => 102, 'saldo_normal' => 'Debit'],
